...
def run_pipeline(image_path: str, prediction: dict[str, Any]) -> PipelineResult:
    ...
    geometry = extract_geometry_features(metadata.prediction)
    ...
    explanation = (
        ...
        f"Geometry area={geometry.area:.2f}, stability={stability.score:.2f}."
    )
    ...
    return PipelineResult(
        ...
        geometry_score=round(geometry.score, 4),
